    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="flex flex-row items-center">
                <div class="w-1/2 text-gray-500">
                    <span class="font-bold">{{ selectedUserChannels?.newsletter?.name }}</span> Opzioni
                </div>
                <div class="w-1/2 text-right">
                    ...
                    <button class="btn btn-sm btn-link transition-transform duration-300"
                            ...
                            type="button"
                            @click="channelOptionsGET(form.user_id, 'newsletter', 'lists')">
        ...
        <div class="card-body">
            ...
            <label class="form-label">
                Liste
                <br>
                <small>Seleziona le liste alle quali vuoi inviare il post</small>
            </label>

            <div class="row !mt-2">
                <div v-if="
                        form.channels['newsletter'] &&
