...
<template>
    ...
    <div v-if="selectedUserChannels?.facebook?.reply_on === '1'"
         class="card">
        <div class="card-header !text-gray-500">

            <span class="font-bold">{{ selectedUserChannels?.facebook?.name }}</span> Opzioni
        ...
        <div class="card-body">
            ...
            <div class="form-check form-switch !mb-3">
                ...
                <input class="form-check-input"
                       ...
                       true-value="1"
                       :false-value=null
                       v-model="form.channels['facebook']['reply_on']"
                       checked />
