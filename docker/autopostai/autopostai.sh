...
# Crontab
# *   *   *   *   *   /var/www/vhosts/server-j.com/autopostai.server-j.com/docker/autopostai/autopostai.sh >> /root/autopostai.log 2>&1
...
(
    ...
    # Verifico se AutoPostAI è in aggiornamento
    if [ ! -f "../../../marker_deploy" ]; then
